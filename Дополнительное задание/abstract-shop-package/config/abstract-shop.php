...
return [
    ...
    /*
     |----------------------------------------------------------------------
     | API настройки (усложнённое задание)
     |----------------------------------------------------------------------
     | version — ожидаемая версия протокола в заголовке X-API-VERSION.
     | prefix  — префикс API-маршрутов пакета (маршруты не публикуются).
     */
    'api' => [
        'version' => (int) env('ABSTRACT_SHOP_API_VERSION', 1),
        'prefix' => env('ABSTRACT_SHOP_API_PREFIX', 'api/shop'),
    ],
];
