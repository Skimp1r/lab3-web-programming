...
@section('title', 'Создать склад')

@section('content')
    <h1 class="h3 mb-3">Создать склад</h1>

    <form method="POST" action="{{ route('abstract-shop.warehouses.store') }}" class="card card-body bg-white">
        @csrf
        <div class="mb-3">
